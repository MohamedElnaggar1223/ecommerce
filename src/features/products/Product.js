...
function Product({ userId, product, selectedCategories }) 
{
    ...
    return (
        <>
            <div onClick={() => setClicked(true)} className='Product'>
            ...
            {
                clicked &&
                <div onClick={() => setClicked(false)} className='SingleProductContainer'>
                    <div className='SingleProduct'>
                        ...
                        <div className='SingleProductInfo'>
                            ...
                            <div className='SingleProductExtraInfos'>
                                {product?.additionalInfo && Object.keys(product?.additionalInfo).map((info) => <div className='SingleProductExtraInfo'><span>{info}</span>: {product?.additionalInfo[info]}</div>)}
                            </div>
                            <div className='SingleProductAddButton'>
                                <button>Add To Cart</button>
                            </div>
                        </div>
                        <div className='ExitSingleProduct'>
