...
function OutofStockProd({ userId, product, selectedCategories }) 
{
    return (
        <Box 
            ...
            position='relative'
        >
            <Box borderRadius={5} position='absolute' bgcolor='#161B1C' width='300px' height='460px' zIndex={99} sx={{ opacity: 0.3 }}></Box>
            <Box
                position='absolute'
                top='78.5%'
                left='5%'
            ...
            >
                ...
                >
                    ...
                    <SvgIcon
                        ...
                        className='Heart'
                    >
                        <svg className='Heart' xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none">
